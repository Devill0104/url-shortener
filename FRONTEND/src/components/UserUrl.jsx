...
const UserUrl = () => {
  ...
  return (
    <div className="bg-[#F1F1F1] w-[80%] mx-auto rounded-lg mt-10 shadow-md overflow-hidden">
      <div className="overflow-x-auto h-56 bg-[#F1F1F1]">
                ...
                <tr key={url._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4">
                    <div className="text-sm text-gray-900">
                      <span className="px-5 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">
                        {url.clicks} {url.clicks === 1 ? 'click' : 'clicks'}
                      </span>
                    </div>
                  </td>
                  <td className="px-10 py-4 text-sm font-medium">
                    <button
